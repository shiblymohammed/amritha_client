      ...
      <section className="relative h-[70vh] overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-foreground-on-color px-6 animate-fadeInUp">
          ...
          <div className="opacity-0 animate-[fadeInUp_0.8s_ease-out_0.3s_forwards]">
            <h1 
              className="font-cinzel text-4xl md:text-5xl lg:text-6xl mb-6 leading-tight animate-float"
            >
        ...
        <div className="container mx-auto px-6 lg:px-8">
          ...
          <div className="text-center mb-12 space-y-6">
            ...
            <p className="font-cormorant text-xl text-foreground-subtle max-w-2xl mx-auto">
              We respond promptly to all enquiries. Choose the best way to reach us below.
            </p>
          </div>
              ...
              >
                <div className="flex items-start gap-4 p-8">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="font-cormorant text-lg text-text-subtle leading-relaxed whitespace-pre-line">
+91 471 2220024 / 2220025
+91 471
                    </p>
                    <a href="tel:+914712220024" className="btn btn-primary mt-3 inline-flex">Call Now</a>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="p-8">
                  <h3 className="font-playfair text-2xl text-text-heading mb-3">Hours</h3>
                  <p className="font-cormorant text-lg text-text-subtle leading-relaxed">Front Desk: 24/7</p>
                  <p className="font-cormorant text-lg text-text-subtle leading-relaxed">Restaurant: 7:00 AM – 10:30 PM</p>
                </div>
              </motion.div>
            </div>
      ...
      <section className="py-16 md:py-24 bg-background-secondary">
        <div className="container mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { title: 'Room Availability', desc: 'Check dates, room types and seasonal offers.' },
              { title: 'Event Enquiries', desc: 'Plan weddings, meetings and private gatherings.' },
              { title: 'Dining & Specials', desc: 'Menus, timings and chef’s recommendations.' }
            ].map((item, i) => (
              <div key={i} className="card-base border border-border hover-lift p-6">
                <h3 className="font-playfair text-h4 text-text-heading mb-2">{item.title}</h3>
                <p className="font-cormorant text-foreground-subtle">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
