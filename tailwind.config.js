  ...
  plugins: [
    ...
    plugin(function({ addComponents, theme }) {
      addComponents({
        ...
        '.btn-primary': {
          color: theme('colors.foreground-on-color'),
          backgroundImage: theme('backgroundImage.forest'),
          ...
          '.dark &': {
             backgroundImage: `linear-gradient(to right, ${theme('colors.accent.DEFAULT')}, ${theme('colors.accent.hover')})`,
          }
        },
        '.btn-secondary': {
